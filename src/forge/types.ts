...
// ---------------------------------------------------------------------------
// Forge response envelope (output-contracts spec)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// POST /forge/ingest/issue — request / response
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// GET /forge/ingest/board/{id} — request / response
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// POST /forge/output/confirm/{run_id}
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Rovo agent action surfaces (task 3.x)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Subagent scoping (tasks 5.x)
// ---------------------------------------------------------------------------

export interface SubagentScope {
  project_key: string;
  confluence_space?: string;
  repo_resources: string[];   // e.g. ["repo://my-repo/*"]
  policy_resources: string[]; // e.g. ["policy://PROJ/*"]
}
