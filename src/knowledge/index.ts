...
import { parseBuffer, parseHtml } from "./parser.js";
...
import type { KBChunk, KBSource, IngestResult, RetrievedChunk } from "./types.js";
...
export class KnowledgeBase {
  ...
  async ingestFile(
    ...
    const chunks: KBChunk[] = rawChunks.map((c, i) => ({
      chunk_id: randomUUID(),
      source_id: sourceId,
      source_type: "kt",
  ...
  private async _guardStoreSize(incomingBytes: number): Promise<void> {
