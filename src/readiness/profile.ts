...
export const DEFAULT_STORY_PROFILE: ReadinessProfile = {
  id: "default:story",
  ...
  dimensions: [
    {
      ...
      clarificationTemplate:
        "What is the business outcome this story is intended to achieve for {ticket_key}? Please add a brief goal statement to the description.",
    },
    {
      ...
      clarificationPersona: "pm",
      clarificationTemplate:
        "What are the measurable acceptance criteria for {ticket_key}? Please provide at least one verifiable success condition.",
    },
    {
      id: "scope_boundaries",
      ...
      clarificationPersona: "pm",
      clarificationTemplate:
        "What is explicitly out of scope for {ticket_key}? Adding a brief 'Not in scope' section will prevent scope creep.",
    },
    {
      ...
      clarificationTemplate:
        "Are there any service or ticket dependencies for {ticket_key}? Please declare them as 'is blocked by' links so they appear in the dependency graph.",
    },
    {
      ...
      clarificationPersona: "engineer",
      clarificationTemplate:
        "Does {ticket_key} have any rollout constraints (feature flags, dark launches, migration steps)? If so, please document them in the description.",
    },
    {
      id: "test_hints",
      label: "Test Hints",
      ...
      clarificationTemplate:
        "What test scenarios should QA validate for {ticket_key}? Adding test hints to the acceptance criteria will speed up test planning.",
    },
  ],
};

export const DEFAULT_BUG_PROFILE: ReadinessProfile = {
  id: "default:bug",
  ...
  dimensions: [
    {
      ...
      clarificationPersona: "pm",
      clarificationTemplate:
        "What is the actual (broken) behaviour observed in {ticket_key}? Please describe it clearly in the description.",
    },
    {
      ...
      clarificationPersona: "pm",
      clarificationTemplate:
        "What is the expected (correct) behaviour for {ticket_key}? Please add the expected outcome to the description or acceptance criteria.",
    },
    {
      id: "repro_steps",
      ...
      clarificationPersona: "engineer",
      clarificationTemplate:
        "Can you provide step-by-step reproduction instructions for {ticket_key}? This is the single most important field for diagnosing the bug.",
    },
    {
      id: "environment",
      label: "Environment",
      ...
      clarificationPersona: "engineer",
      clarificationTemplate:
        "In which environment was {ticket_key} observed (production / staging / local)? What version or deployment was running?",
    },
    {
      id: "evidence",
      ...
      clarificationPersona: "engineer",
      clarificationTemplate:
        "Are there any logs, screenshots, or traces attached to {ticket_key}? Please attach or link them — they dramatically reduce investigation time.",
    },
    {
      ...
      clarificationPersona: "engineer",
      clarificationTemplate:
        "Which services or components are affected by {ticket_key}? Please add relevant service labels.",
    },
    {
      id: "exit_criteria",
      label: "Exit Criteria",
      ...
      clarificationPersona: "qa",
      clarificationTemplate:
        "How will we verify that {ticket_key} is fixed? Please add an acceptance criterion describing the passing state.",
    },
  ],
};

export const DEFAULT_TASK_PROFILE: ReadinessProfile = {
  id: "default:task",
  ...
  dimensions: [
    {
      ...
      clarificationPersona: "pm",
      clarificationTemplate:
        "The summary for {ticket_key} is too vague. Can you rewrite it as '<verb> <object> so that <outcome>'?",
    },
    {
      id: "acceptance_criteria",
      ...
      clarificationPersona: "pm",
      clarificationTemplate:
        "How will we know {ticket_key} is complete? Please add a brief definition of done.",
    },
    {
      id: "dependencies_declared",
      label: "Dependencies Declared",
      ...
      clarificationPersona: "engineer",
      clarificationTemplate:
        "Does {ticket_key} depend on any other tickets or services? If so, please add 'is blocked by' links.",
    },
    {
      id: "assignee_set",
      label: "Assignee Set",
      ...
      clarificationPersona: "pm",
      clarificationTemplate:
        "Who is responsible for delivering {ticket_key}? Please set an assignee.",
    },
  ],
};
...
const BUILT_IN_PROFILES: ReadinessProfile[] = [
...
export class ProfileRegistry {
  private readonly profiles: Map<string, ReadinessProfile> = new Map();
  ...
  resolve(
    projectKey: string,
    issueType: string
  ): { profile: ReadinessProfile; source: "project" | "default" } {
