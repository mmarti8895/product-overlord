...
import { DEFAULT_STORY_PROFILE, DEFAULT_BUG_PROFILE, ProfileRegistry, } from "../../readiness/profile.js";
// ---------------------------------------------------------------------------
// Fixtures
// ---------------------------------------------------------------------------
function makeStory(overrides = {}) {
    return {
        ...
        acceptance_criteria: "Given valid credentials, when user clicks Login, then user sees dashboard.",
...
function makeBug(overrides = {}) {
    return {
        ...
        description: "Steps: 1. Open Safari 16. 2. Navigate to /login. 3. Click Login.\n" +
