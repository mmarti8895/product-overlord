...
import { enqueueReflection, approveCandidate, rejectCandidate, getReflectionQueue, getCandidateById, getPendingPolicyDeltas, getPendingRepoMemoryDeltas, _clearReflectionQueue, _clearPromotionStores, } from "../../eval/reflection-agent.js";
import { evidenceStore } from "../../evidence/store.js";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
function seedEvidenceBundle(verdict) {
